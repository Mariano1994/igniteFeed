...
const Sidebar = () => {
  return (
    <div className=" flex flex-col gap-4">
      ...
      <button className="group flex items-center justify-center gap-1 py-2 px-4 border-2 border-green-850 rounded-lg cursor-pointer  hover:bg-green-850">
        <Plus size={20} className="text-green-850 group-hover:text-white" />
        <a
          href="#"
          className="text-green-850  font-semibold group-hover:text-white "
        >
          Create post
        </a>
      </button>
